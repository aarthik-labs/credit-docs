...
|---|---|---|---|
| `borrowerProviderID` | `string` | Yes | Non-empty unique borrower reference from your system (read: [Borrower Identity Mapping (Important)](#borrower-identity-mapping-important)) |
